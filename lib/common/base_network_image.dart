...
import 'package:webtoon/common/a_skeleton.dart';

enum TypeCacheKey { unknown, aws }
...
class BaseNetworkImage extends StatelessWidget {
  ...
  final TypeCacheKey? typeCacheKey;
  ...
  Widget _defaultIndicatorPlaceholder(
  ...
  String? get cacheKeyValue {
    if (typeCacheKey == TypeCacheKey.aws) {
      return imageUrl.split("?X").first;
    }
